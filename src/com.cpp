...
namespace SysInfo::COM {
    ...
    COMWrapper::~COMWrapper() noexcept { Uninitialize(); }
	...
	bool COMWrapper::IsInitialized() const noexcept { return m_isInitialized; }
	bool COMWrapper::IsConnected() const noexcept { return m_isConnected; }
	std::string COMWrapper::GetLastError() const noexcept { return m_lastError; }
	HRESULT COMWrapper::GetLastErrorCode() const noexcept { return m_lastErrorCode; }
